...
Java 应该是我学的第一门后端语言，可能是学的比较早，尽管那时候已经是 1.8 了，但是在当时的 Java 教程里都没有讲过 Java 的一些新特性。虽然后来浏览一些技术文章或多或少的看到过过一些 Lambda ，Stream 之类的介绍，但是从来没有认真的看过。趁着周末在家没事就把这些知识补了一下。
